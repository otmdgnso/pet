				...
				<table
					...
					<tr
						...
						<td><input id="messageReceiveUserId" type="text"
							name="receiveUserId"
							style="width: 100%; height: 50%; font-size: 16px; border: none;"
							readonly="readonly" value="${dto.sendUserId}"></td>
					</tr>
					...
					<tr
						...
						<td><input id="messageReceiveUserId" type="text"
							name="receiveUserId"
							style="width: 100%; height: 50%; font-size: 16px; border: none;"
							value="${dto.receiveUserId}" readonly="readonly"></td>
					</tr>
					...
					<tr
						...
						<td><input id="messageReceiveUserId" type="text"
							name="receiveUserId"
							style="width: 100%; height: 50%; font-size: 16px; border: none;"
							value="${dto.sendCreated}" readonly="readonly"></td>
					</tr>
					...
					<tr
						...
						<td><input type="text" id="messageSubject" name="subject"
							style="width: 100%; height: 50%; font-size: 16px; border: none;"
							readonly="readonly" value="${dto.subject}"></td>
					</tr>
					...
					<tr
						...
						<td colspan="2"><textarea id="messageContent" name="content"
								rows="8" cols="50%" style="font-size: 16px; border: none;"
