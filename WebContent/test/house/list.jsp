                ...
                <section class="ac-container">
				    ...
				    <div>
					    ...
					    <article class="ac-medium">
						    <div class="rating-trip"><i class="fa fa-check-square-o"></i><img src="images/star.png" alt="1 Star"/><p>(975) result</p></div>
                            <div class="rating-trip"><i class="fa fa-check-square-o"></i><img src="images/2star.png" alt="2 Star"/><p>(1335) result</p></div>
                            <div class="rating-trip"><i class="fa fa-check-square-o"></i><img src="images/3star.png" alt="3 Star"/><p>(1732) result</p></div>
                            <div class="rating-trip"><i class="fa fa-check-square-o"></i><img src="images/4star.png" alt="4 Star"/><p>(665) result</p></div>
                            <div class="rating-trip"><i class="fa fa-check-square-o"></i><img src="images/5star.png" alt="5 Star"/><p>(412) result</p></div>
					    </article>
				    </div>
				    <div>
					...
					<ul id="Grid" class="sandbox">
						<li class="mix category-3" data-value="1250">
							<figure>
								...
								<figcaption>
                                    <h3>Polinesia</h3><img class="star-level" src="images/5star.png" alt="" />
                                    <div class="clear"></div>
						...
						<li class="mix category-2" data-value="850">
							<figure>
								...
								<figcaption>
                                    <h3>Gran Canaria</h3><img class="star-level" src="images/3star.png" alt="" />
                                    <div class="clear"></div>
                                    <p>Chillwave hoodie ea gentrify aute sriracha consequat, cursus libero purus ac congue ar lorem.</p>
						...
						<li class="mix category-3" data-value="700">
							<figure>
								...
								<figcaption>
                                    <h3>Fashion Palace</h3><img class="star-level" src="images/4star.png" alt="" />
                                    <div class="clear"></div>
                                    <p>Chillwave hoodie ea gentrify aute sriracha consequat, cursus libero purus ac congue ar lorem.</p>
						...
						<li class="mix category-1" data-value="1050">
							<figure>
								...
								<figcaption>
                                    <h3>Playa Hotel</h3><img class="star-level" src="images/4star.png" alt="" />
                                    <div class="clear"></div>
                                    <p>Chillwave hoodie ea gentrify aute sriracha consequat, cursus libero purus ac congue ar lorem.</p>
						...
						<li class="mix category-1" data-value="330">
							<figure>
								...
								<figcaption>
                                    <h3>PORTALS PALACE</h3><img class="star-level" src="images/star.png" alt="" />
                                    <div class="clear"></div>
                                    <p>Chillwave hoodie ea gentrify aute sriracha consequat, cursus libero purus ac congue ar lorem.</p>
						...
						<li class="mix category-1" data-value="480">
							<figure>
								...
								<figcaption>
                                    <h3>BEACH RESORT</h3><img class="star-level" src="images/2star.png" alt="" />
                                    <div class="clear"></div>
                                    <p>Chillwave hoodie ea gentrify aute sriracha consequat, cursus libero purus ac congue ar lorem.</p>
						...
						<li class="mix category-2" data-value="1100">
							<figure>
								...
								<figcaption>
                                    <h3>BAOBAB Place</h3><img class="star-level" src="images/5star.png" alt="" />
                                    <div class="clear"></div>
                                    <p>Chillwave hoodie ea gentrify aute sriracha consequat, cursus libero purus ac congue ar lorem.</p>
						...
						<li class="mix category-3" data-value="560">
							<figure>
								...
								<figcaption>
                                    <h3>ROULETTE </h3><img class="star-level" src="images/3star.png" alt="" />
                                    <div class="clear"></div>
                                    <p>Chillwave hoodie ea gentrify aute sriracha consequat, cursus libero purus ac congue ar lorem.</p>
						...
						<li class="mix category-1" data-value="510">
							<figure>
								...
								<figcaption>
                                    <h3>CORAL RESORT </h3><img class="star-level" src="images/3star.png" alt="" />
                                    <div class="clear"></div>
                                    <p>Chillwave hoodie ea gentrify aute sriracha consequat, cursus libero purus ac congue ar lorem.</p>
						...
						<li class="mix category-2" data-value="1300">
							<figure>
								...
								<figcaption>
                                    <h3>BLUE HOTEL</h3><img class="star-level" src="images/4star.png" alt="" />
                                    <div class="clear"></div>
                                    <p>Chillwave hoodie ea gentrify aute sriracha consequat, cursus libero purus ac congue ar lorem.</p>
						...
						<li class="mix category-2" data-value="650">
							<figure>
								...
								<figcaption>
                                    <h3>DONG OCEAN</h3><img class="star-level" src="images/2star.png" alt="" />
                                    <div class="clear"></div>
                                    <p>Chillwave hoodie ea gentrify aute sriracha consequat, cursus libero purus ac congue ar lorem.</p>
						...
						<li class="mix category-1" data-value="970">
							<figure>
								...
								<figcaption>
                                    <h3>Paul Place</h3><img class="star-level" src="images/3star.png" alt="" />
                                    <div class="clear"></div>
                                    <p>Chillwave hoodie ea gentrify aute sriracha consequat, cursus libero purus ac congue ar lorem.</p>
